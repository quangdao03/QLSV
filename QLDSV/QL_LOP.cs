...
namespace QLDSV
{
    public partial class QL_LOP : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qLDiemsvDataSet.LOP' table. You can move, or remove it, as needed.
            this.lOPTableAdapter.Fill(this.qLDiemsvDataSet.LOP);
            String connection = ConfigurationManager.ConnectionStrings["QLDSV.Properties.Settings.QLDiemsvConnectionString"].ConnectionString.ToString();
