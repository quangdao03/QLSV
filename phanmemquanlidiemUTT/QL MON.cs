...
namespace phanmemquanlidiemUTT
{
    public partial class QL_MON : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'uTTquanlisvDataSet.MON' table. You can move, or remove it, as needed.
            this.mONTableAdapter.Fill(this.uTTquanlisvDataSet.MON);
            String connection = ConfigurationManager.ConnectionStrings["phanmemquanlidiemUTT.Properties.Settings.UTTquanlisvConnectionString"].ConnectionString.ToString();
        ...
        private void QL_MON_FormClosing(object sender, FormClosingEventArgs e)
        {
            con.Close();
        }
    }
