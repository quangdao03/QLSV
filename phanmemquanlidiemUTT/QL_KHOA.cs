...
namespace phanmemquanlidiemUTT
{
    public partial class QL_KHOA : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'uTTquanlisvDataSet.KHOA' table. You can move, or remove it, as needed.
            this.kHOATableAdapter.Fill(this.uTTquanlisvDataSet.KHOA);
